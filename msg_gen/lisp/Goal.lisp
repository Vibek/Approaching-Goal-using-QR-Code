...
(cl:defmethod cl:initialize-instance :after ((m <Goal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Goal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name QRcode_detection-msg:<Goal> is deprecated: use QRcode_detection-msg:Goal instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Goal>))
